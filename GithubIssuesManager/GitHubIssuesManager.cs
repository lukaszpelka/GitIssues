...
namespace GitHubIssuesManager
{
    ...
    {
        public async Task<HttpResponseMessage> AddIssue(string name, string description)
        {
        ...
        public async Task<HttpResponseMessage> CloseIssue(int issueNumber)
        {
            using (var client = new HttpClient())
            {
        ...
        public async Task<HttpResponseMessage> GetAllIssues()
        {
            using (var client = new HttpClient())
            {
        ...
        public async Task<HttpResponseMessage> ModifyIssue(string name, string description, int issueNumber)
        {
            using (var client = new HttpClient())
            {
                using (var request = new HttpRequestMessage(HttpMethod.Patch, $"https://api.github.com/repos/lukaszpelka/GitIssues/issues/{issueNumber}"))
